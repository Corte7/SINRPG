...
Only one point of Luck may be spent at once.
...
There exists a skill List - Identical to SIN Skill ListSocial Skills are instead tied to the topic of discussion, for instance convincing someone that their security is compromised would require a Security Systems roll as opposed to a “Deception” roll. Characters may also use StreetDeal/CorpDeal/Matrix Lore as skills to interact with people that belong to each of these types making them effectively Social Skills.